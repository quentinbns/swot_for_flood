...
if __name__ == "__main__":
    ...
    for time in swot_project.swot_collection.swot_flood_dates:
        print(f"Processing time: {time}", flush=True)
        exact_time = swot_project.swot_collection.get_variable("gamma_tot", "global", "swot", None).sel(time=time)
        str_time = exact_time.time.dt.strftime("%Y%m%dT%H%M%S").values
